...
import com.mcifald.model.ModelObsidianTable;
import com.mcifald.tileentity.TileEntityObsidianTable;

public class RenderObsidianTable extends TileEntitySpecialRenderer {

	private static final ResourceLocation texture = new ResourceLocation(McIfald.modid + ":" + "textures/model/ObsidianTable.png");
