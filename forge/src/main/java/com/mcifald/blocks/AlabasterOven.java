...
public class AlabasterOven extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(McIfald.modid + ":" + "AlabasterOvenSide");
		this.iconFront = iconRegister.registerIcon(McIfald.modid + ":" + (this.isActive ? "AlabasterOvenFrontOn" : "AlabasterOvenFrontOff"));
		this.iconTop = iconRegister.registerIcon(McIfald.modid + ":" + "AlabasterOvenTop");
	}
	...
	public Item getItemDropped(int i, Random random, int j) {
		return Item.getItemFromBlock(McIfald.blockAlabasterOvenIdle);
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		if(!world.isRemote) {
			FMLNetworkHandler.openGui(player, McIfald.instance, McIfald.guiIDAlabasterOven, world, x, y, z);
		}
		return true;
	}
	...
	public static void updateAlabasterOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
		...
		if(active) {
			worldObj.setBlock(xCoord, yCoord, zCoord, McIfald.blockAlabasterOvenActive);
		}else{
			worldObj.setBlock(xCoord, yCoord, zCoord, McIfald.blockAlabasterOvenIdle);
		}
