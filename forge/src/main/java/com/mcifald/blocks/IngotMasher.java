...
public class IngotMasher extends BlockContainer {
	...
	public void registerBlockIcons(IIconRegister iconRegister) {
		this.blockIcon = iconRegister.registerIcon(McIfald.modid + ":" + (this.isActive ? "IngotMasherSideOn" : "IngotMasherSideOff"));
		this.iconFront = iconRegister.registerIcon(McIfald.modid + ":" + (this.isActive ? "IngotMasherFrontOn" : "IngotMasherFrontOff"));
	}
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    	if (world.isRemote) {
    		...
    		if (entity != null) {
    			FMLNetworkHandler.openGui(player, McIfald.instance, McIfald.guiIDIngotMasher, world, x, y, z);
    		}
    		return true;
    	}else{
    		return false;
	...
	public static void updateBlockState(boolean isMashing, World world, int xCoord, int yCoord, int zCoord) {
		...
		if (isMashing) {
			world.setBlock(xCoord, yCoord, zCoord, McIfald.blockIngotMasherActive);
		}else{
			world.setBlock(xCoord, yCoord, zCoord, McIfald.blockIngotMasherIdle);
		}
