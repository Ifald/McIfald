package com.mcifald.tileentity;
...
import com.mcifald.blocks.IngotMasher;
import com.mcifald.crafting.IngotMasherRecipes;
...
public class TileEntityIngotMasher extends TileEntity implements ISidedInventory {
	...
	private static int getItemPower (ItemStack itemstack) {
		if (itemstack == null) {
			...
			if (item == McIfald.itemTreePitch) return 50;
